...
const createTables = () => {
  ...
  `, (err) => {
    if (err) {
      ...
      console.log('✅ Workout days table created successfully');
    }
  });
  ...
  `, (err) => {
    if (err) {
      ...
      console.log('✅ Weekly updates table created successfully');
    }
  });
  ...
  `, (err) => {
    if (err) {
      ...
      console.log('✅ Weekly plans table created successfully');
    }
  });
...
const insertSampleGoals = () => {
  const sampleGoals = [
    ...
    },
    {
      ...
      user_id: 'user-2',
      category: 'strength',
      description: 'Deadlift 1.5x body weight',
      is_difficult: 0,
      is_completed: 0,
      completed_date: null,
      created_date: '2026-01-19'
    },
    {
      ...
      description: 'Complete 30 days of morning workouts without missing a day',
      is_difficult: 0,
      is_completed: 0,
      completed_date: null,
      created_date: '2026-01-19'
